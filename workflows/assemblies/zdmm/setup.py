...
from workflows.assemblies import HSV1, IAV, GRCm39

if __name__ == "__main__":
    iav, hsv1, grcm39 = IAV(), HSV1(), GRCm39()

    # Concatenate, compress, and index a chimeric FASTA reference
    fasta = [x.files('FASTA') for x in (iav, hsv1, grcm39)]
    ...
    gff3 = [iav.files("GFF3"), hsv1.files("GFF3"), grcm39.files("GENCODE")]
