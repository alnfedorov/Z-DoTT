...
zcat "${ASSEMBLIES}/CHM13v2/gencode/CHM13v2.liftoff+gencode-48.gff3.gz" > indexes/CHM13v2/annotation.gff3

mkdir -p indexes/GRCm39
zcat "${ASSEMBLIES}/GRCm39/GRCm39.primary_assembly.genome.fa.bgz" > indexes/GRCm39/sequence.fa
zcat "${ASSEMBLIES}/GRCm39/gencode/gencode.vM37.primary_assembly.annotation.gff3.gz" > indexes/GRCm39/annotation.gff3
