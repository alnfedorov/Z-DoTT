...
def experiment_builder(
    ...
    if "Z22 RIP" in library.selection:
        selection = "Z22-RIP"
...
def project_builder(
    ...
    assert len(inds) == 1
    return seqproj.Project(f"MEF HSV-1 batch 1 [{ROOT.name}, {inds[0]}]", experiments, samples)
...
remapping = {
    "A1": "A1+E2", "B1": "B1+F2", "D1": "D1+H2", "E1": "E1+A3", "G1": "G1+C3",
    "H1": "H1+D3", "B2": "B2+F3", "C2": "C2+G3", "E2": "A1+E2", "F2": "B1+F2",
