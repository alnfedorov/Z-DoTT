...
for exp in project.experiments:
    ht29, condition, selection, postfix = exp.sample.attributes.pop('title').split(', ')
    assert ht29 == "HT-29"
    assert condition in {"mock", "IAV", "HSV-1"}
    ...
    exp.sample.attributes["cells"] = "HT-29"
    ...
    title = f"HT-29_{condition}_{selection}_{replica}"
...
object.__setattr__(project, "description", "FLAG/Z22 RIP-seq from HSV-1-/IAV-infected HT-29 cells")
